...
class PilotAdmin extends CodonModule {
    ...
    public function HTMLHead() {
        switch (self::$controller->function) {
            case 'viewpilots':
                $this->set('sidebar', 'sidebar_pilots');
                break;
            case 'pendingpilots':
                $this->set('sidebar', 'sidebar_pending');
                break;
            case 'pilotgroups':
            case 'editgroup':
            case 'addgroup':
                $this->set('sidebar', 'sidebar_groups');
                break;
        }
    }
    ...
    public function resendemail($show_pending = true) {
        ...
        $message = Template::getTemplate('email_registrationaccepted', true, true, true);
    ...
    public function viewbids() {
        ...
        $this->render('pilots_viewallbids');
    }
    ...
    protected function RejectPilot() {
        ...
        $message = Template::Get('email_registrationdenied', true, true, true);
