...
class PilotRanking extends CodonModule {
	public function HTMLHead() {
		switch (self::$controller->function) {
			case 'pilotranks':
			case 'calculateranks':
				$this->set('sidebar', 'sidebar_ranks');
				break;

			case 'awards':
				$this->set('sidebar', 'sidebar_awards');
				break;
		}
	}
