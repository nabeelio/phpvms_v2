...
class SiteCMS extends CodonModule
{
	public function HTMLHead() {
		switch(self::$controller->function) {
			case 'addnews':
			case 'viewnews':
				$this->set('sidebar', 'sidebar_news');
				break;
			
			case 'viewpages':
				$this->set('sidebar', 'sidebar_pages');
				break;
				
			case 'addpageform':
				$this->set('sidebar', 'sidebar_addpage');
				break;
		}
	}
